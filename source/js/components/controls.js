...
define([
    ...
    var Controls = React.createClass({displayName: 'Controls',
        ...
        render: function() {
           ...
           res.push(
                React.DOM.div({className: "logo"}, "Class Room")
                );
            ...
            if(this.props.state.state === Constants.AppState.FOYER) {
                ...
                res.push(
                    React.DOM.div({className: "description"}, 
                        React.DOM.p(null, 
                            "Start a FREE classroom", React.DOM.br(null), "with up to ", Configs.maxUsers, " people"
                        ), 
                        React.DOM.p(null, 
                            "Just hit the \"Start a new classroom\" button below and share the link.", React.DOM.br(null), React.DOM.br(null)
                        )
                    )
                );
	                res.push(
                    React.DOM.div({className: "link"}, 
                        React.DOM.p(null, "Room Name"), 
                        React.DOM.input({name: "roomName", id: "roomName", type: "text", placeholder: "Enter Your Room Name Here."})
                    )
                    );
            }
                ...
                res.push(
                    React.DOM.div({className: "link"}, 
                        "Share this link to invite others into this classroom", React.DOM.br(null), 
